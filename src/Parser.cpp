...
void Parser::parse_input_problem(const std::string& input_file)
{
}
...
void Parser::read_header(std::istream& str) {
...
void Parser::check_marker(std::istream& str, std::string marker) {
	std::string word;
	str >> word;
...
Variable Parser::initialize_variable(std::istream& str) {
...
void Parser::get_variables(std::istream& str, 
...
void Parser::get_init(std::istream&          str,
                      std::vector<Variable>& variables,
                      State&                 initial_state) {
...
void Parser::get_goal(std::istream&                str,
...
Operator Parser::create_operator(std::istream&          str,
                                 std::vector<Variable>& variables) {
...
void Parser::get_operators(std::istream&          str, 
...
void Parser::parse(std::istream&            str, 
                   std::vector<Variable>&   variables, 
                   std::map<Variable, int>& goals,
                   std::vector<Operator>&   operators,
                   State&                   initial_state) {
